export default {
  ...
  description:
    "A beautiful React component for displaying Tamil daily calendar sheets",
  ...
  define: {
    __DOCS_URL__: JSON.stringify(
      process.env.DOCS_BASE_URL || "https://docs.kanaksan.com/"
    ),
    __CONTACT_EMAIL__: JSON.stringify(
      process.env.API_CONTACT_EMAIL || "helpdesk@kanaksan.com"
    ),
  },
  ...
  themeConfig: {
    ...
    socialLinks: [
      {
        icon: "github",
        link: "https://github.com/kanaksan-dev/tamil-calendar-widget-docs",
      },
    ],
    footer: {
